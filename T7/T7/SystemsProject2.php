...
<!--    Team7.html       Working home page for Book Buyers site
	...
	<!-- HEADER WITH NAV BUTTONS END HERE -->
	 ...
	 <header style =  "text-align: center"> Welcome to the Book Buyer home page!</header> 
			...
			<!-- Featured books-->
			<h3 style = "color: purple; text-align: center;"><a href = "google.com"> HERE ARE TODAY'S FEATURED BOOKS: </a> </h3>
        <p> 
            ...
            <br>
			<p style = "text-align: center; color: red; font-size: 40px"> <b> You must be at least 13 years old to access this site
